...
pub trait Datastore {
    ...
    fn set_vertex_properties(&self, q: models::VertexPropertyQuery, value: Vec<u8>) -> Result<()>;
    ...
    /// * `q`: The query to run.
    /// * `value`: The property value.
    fn set_edge_properties(&self, q: models::EdgePropertyQuery, value: Vec<u8>) -> Result<()>;
